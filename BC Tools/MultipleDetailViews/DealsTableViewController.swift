...
class DealsTableViewController: UITableViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "dealDetails"{
            ...
            let secondScene = segue.destinationViewController as! DealsDetailsViewController
    ...
    func loadData(sender:AnyObject) {
        ...
        query.findObjectsInBackgroundWithBlock({ (objects: [PFObject]?, error: NSError?) -> Void in
            if error == nil {
                ...
                self.stopActivityIndicator()
                let alert = UIAlertController(title: "Cannot Get Deals", message: "No Internet connection available.", preferredStyle: UIAlertControllerStyle.Alert)
