...
class EventsTableViewController: UITableViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "eventDetails"{
            // Hide tab bar in child view.
            let bottomBar = segue.destinationViewController 
            bottomBar.hidesBottomBarWhenPushed = true
            
            
            // Get the new view controller using [segue destinationViewController].
            let secondScene = segue.destinationViewController as! EventsDetailsViewController
            ...
            if error == nil {
                ...
                if let objects = objects as [PFObject]! {
                    ...
                    for object in objects {
                        ...
                        let newEvent = event(image : (object.objectForKey("image") as! PFFile),
                        ...
                        let dateOfEvent: NSDate = object.objectForKey("endDate") as! NSDate
                        ...
                        let dateComparisonResult:NSComparisonResult = date.compare(dateOfEvent)
                ...
                self.stopActivityIndicator()
                let alert = UIAlertController(title: "Cannot Get Events", message: "No Internet connection available.", preferredStyle: UIAlertControllerStyle.Alert)
