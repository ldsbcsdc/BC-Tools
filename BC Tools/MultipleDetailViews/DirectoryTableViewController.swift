...
class DirectoryTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        let currentDepart = departments[indexPath.row]
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "dirDetails"{
            ...
            let secondScene = segue.destinationViewController as! DirectoryDetailsViewController
...
//                self.tableView.delegate = nil
    ...
    func loadData(sender: AnyObject) {
        ...
        let query = PFQuery(className: "serviceDirectory")
        ...
        query.findObjectsInBackgroundWithBlock({ (objects: [PFObject]?, error: NSError?) -> Void in
            if error == nil {
                ...
                self.stopActivityIndicator()
                let alert = UIAlertController(title: "Cannot Load Directory", message: "No Internet connection available.", preferredStyle: UIAlertControllerStyle.Alert)
